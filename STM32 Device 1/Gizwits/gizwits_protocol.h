...
* @{
*/
#define PRODUCT_KEY "c0e860bd3c0542928428a0baef4f1e2d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "00c656fda99949a7bb97f57496d08c19"
...
#define Wind_BITOFFSET                     0
#define Wind_LEN                           1
#define LED_BYTEOFFSET                    0
#define LED_BITOFFSET                     1
#define LED_LEN                           1
#define FirstDoor_BYTEOFFSET                    0
#define FirstDoor_BITOFFSET                     2
#define FirstDoor_LEN                           1
#define SecondDoor_BYTEOFFSET                    0
#define SecondDoor_BITOFFSET                     3
#define SecondDoor_LEN                           1
...
typedef struct {
  uint8_t flagWind:1;
  uint8_t flagLED:1;
  uint8_t flagFirstDoor:1;
  uint8_t flagSecondDoor:1;
} attrFlags_t;
